...
void MyGLWidget::createBuffersPatricio ()
{
  ...
  patr.load("/media/hector/TOSHIBA_EXT/FiB/ASSIGN/IDI/LAB/models/Patricio.obj");
...
void MyGLWidget::createBuffersTerraIParet ()
{
  ...
  glm::vec3 diff(0.,0.,1.); // Controla el color de l'objecte, en aquest cas: blau
  glm::vec3 spec(1., 1., 1.); //Relació de reflexió
  float shin = 33; // Porcentatge de reflexio
