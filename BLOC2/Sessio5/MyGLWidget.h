...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    void calcular_extrems(float current[], int size, bool reset); // Per a models importats
    void calcular_extrems(glm::vec3 current[], int size, bool reset); // Per a objectes creats localment
    ...
    glm::vec3 centre_esfera, puntMinim, puntMaxim;
